...
public class ViewLogin extends javax.swing.JFrame {
   ...
   public boolean checkLogin(String login, String senha){
    ...
    private void initComponents() {
        ...
        setTitle("URNA SOFT TAMBOR v1.0");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/logroselha.png"))); // NOI18N

        jLabel4.setBackground(new java.awt.Color(255, 255, 255));
        jLabel4.setFont(new java.awt.Font("Copperplate Gothic Light", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 0, 51));
        jLabel4.setText("SISTEMA DE ACESSO A URNA ELETRÔNICA");
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/house_122791.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(this.checkLogin(txtlogin.getText(), new String(txtsenha.getPassword()))){
            ...
            JOptionPane.showMessageDialog( null, "ACESSO NEGADO. USUARIO NÃO AUTORIZADO ATIVANDO DEFCON 4","ALERTA DE EMERGÊNCIA",JOptionPane.ERROR_MESSAGE);
        }
